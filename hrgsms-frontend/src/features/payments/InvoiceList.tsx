      ...
      <div className="container-app max-w-7xl py-8 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            >
              Pending (
              {invoices.filter((i) => i.invoiceStatus === "Pending").length})
            </button>
            <button
            ...
            {filteredInvoices.map((invoice) => (
              ...
              >
                ...
                <div className="mb-4 pb-4 border-b border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm text-slate-500">
                    Room {invoice.roomNo} - {invoice.roomType}
                  </p>
                  <p className="text-sm text-slate-500">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-mono">
                      Rs {invoice.roomCharges?.toFixed(2) || "0.00"}
                    </span>
                  </div>
                  {invoice.serviceCharges > 0 && (
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-mono">
                        Rs {invoice.serviceCharges.toFixed(2)}
                      </span>
                    </div>
                  )}
                  {invoice.taxAmount > 0 && (
                  ...
                  {invoice.settledAmount > 0 && (
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-mono text-green-600">
                        Rs {invoice.settledAmount.toFixed(2)}
                      </span>
                    </div>
                  )}
                  {invoice.balanceAmount > 0 && (
                    <div className="flex justify-between font-semibold text-red-600 dark:text-red-400">
                      ...
                      <span className="font-mono">
                        Rs {invoice.balanceAmount.toFixed(2)}
                      </span>
                    </div>
                  )}
                </div>
